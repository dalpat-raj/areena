...
import { deleteSellerByAdmin, getAllSellerForAdmin } from '../../../actions/sellerAction';
import { backend__url } from '../../../Server';
import "./adminAllSellers.scss";
import { AiOutlineDelete } from 'react-icons/ai';

const AdminAllSellers = () => {
    const {allSellers, message} = useSelector((state)=>state.seller);
    ...
    <div className="container">
      <div className="dashboard__row">
        ...
        <div className="col__2 admin__sellers">
            {
                allSellers && allSellers?.map((item)=>(
                    <div className="seller__row">
                        ...
                        <div className="delete__seller">
                            <AiOutlineDelete onClick={()=>deleteSellerHandler(item?._id)}/>
                        </div>
