  ...
  return (
    <div className='home__section'>
        <div className="container__fluid">
            ...
            <Carousel autoPlay={true} infiniteLoop={true} showIndicators={true} showStatus={false} transitionTime={"0"} renderArrowPrev={()=>false} renderArrowNext={()=>false} emulateTouch={false} preventMovementUntilSwipeScrollTolerance={true} verticalSwipe={"natural"}>
