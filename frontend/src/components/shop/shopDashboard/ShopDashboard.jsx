    ...
    <div className="dashboard__container">
      <div className="container">
        <div className="dashboard__row">
          ...
          {
            seller?.pinCode?.length === 0 ? (
              <div className="add__pinCode__main">
               <div>
               <h2>If you want to sell products ?</h2>
                <p>So first add pinCode so that you can sell at that location.</p>
                <button className="btn-main" onClick={()=>navigate("/shop-dashboard-delivery-area")}>Add PinCode</button>
               </div>
              </div>
            ) : (
